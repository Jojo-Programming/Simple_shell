...
* @info: pointer inform structure
* @estr: string containing specified error type
* Return:NULL if no numbers in string and
* converted number if not -1 on error
*/
...
/**
 * convert_number - converts number to any base
...
/**
* remove_comments – changes first instance of
* ‘#’ with ‘\0’
